    ...
    slides: [
      {
        ...
        <ul>
          ...
          <li><strong>Funkce odměny $\\mathcal{R}$ (Delayed Sparse Reward)</strong>: Během generování mezilehlých atomů je okamžitá odměna nulová ($r_t = 0$ pro $t < T$). Terminální odměna $R(X) \\in [0, 1]$ je udělena teprve po vygenerování ukončovacího tokenu $\\langle \\text{EOS} \\rangle$, kdy je kompletní molekula $X$ předána prostředí <code>DrugExEnvironment</code> k chemoinformatickému a biologickému vyhodnocení.</li>
